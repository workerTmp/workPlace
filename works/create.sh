...
#sh 1.sh medovecot -only build fuzzers
#sh 1.sh medovecot fuzz_test-mbox-from build fuzzers and start targets
#sh 1.sh medovecot fuzz_test-mbox-from 1 only start targets
